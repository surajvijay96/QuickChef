...
public class Login extends HttpServlet {
	...
	protected void displayLogin(HttpServletRequest request,
		...
		pw.print("<form method='post' action='Login'>"
				...
				+ "</td></tr><tr><td>"
				+ "<h3>User Type</h3></td><td><select name='usertype' class='input'><option value='customer' selected>Customer</option><option value='manager'>Store Manager</option><option value='retailer'>Admin</option></select>"
				+ "</td></tr><tr><td></td><td>"
